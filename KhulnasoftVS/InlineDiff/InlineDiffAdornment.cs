...
namespace KhulnasoftVs.InlineDiff;

internal sealed class Components
{
    internal const string DiffAdornmentLayerName = "KhulnasoftInlineDiffAdornment";
...
[Name("KhulnasoftInlineDiffViewProvider")]
[ContentType("code")]
[TextViewRole(PredefinedTextViewRoles.Document)]
internal class KhulnasoftInlineDiffViewProvider : ILineTransformSourceProvider
{
