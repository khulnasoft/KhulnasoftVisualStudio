...
{
    public const string KhulnasoftVSString = "61329f9d-a7a0-4910-ab50-a7a864a549fd";
    public static Guid KhulnasoftVS = new Guid(KhulnasoftVSString);
...
{
    public const int ToolsSubMenuKhulnasoft = 0x0001;
    public const int ToolsButtonsGroup = 0x0002;
    public const int ContextGroupKhulnasoft = 0x0003;
