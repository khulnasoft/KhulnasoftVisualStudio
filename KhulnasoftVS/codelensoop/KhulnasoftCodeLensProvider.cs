...
namespace KhulnasoftVS
{
    ...
    [Name(Id)]
    [ContentType("text")]
    [LocalizedName(typeof(Resources), "KhulnasoftCodeLensProvider")]
    [Priority(200)]

    internal class KhulnasoftCodeLensProvider : IAsyncCodeLensDataPointProvider
    {
        internal const string Id = "KhulnasoftCodeLens";
        ...
        public KhulnasoftCodeLensProvider(Lazy<ICodeLensCallbackService> callbackService)
        {
            ...
            CancellationToken token)
        {
            ...
            try
            {
                ...
                var name = nameof(ICodeLensListener.IsKhulnasoftCodeLensActive);
        ...
        {
            KhulnasoftDataPoint dp = null;
            try
            {
                dp = new KhulnasoftDataPoint(callbackService.Value, descriptor);
            }
            catch (Exception ex)
            {
                return null;
    ...
    public class KhulnasoftDataPoint : IAsyncCodeLensDataPoint
    {
        private static readonly CodeLensDetailEntryCommand refactorCommand = new CodeLensDetailEntryCommand
        {
            CommandSet = PackageGuids.KhulnasoftVS,
            CommandId = 0x0110,
            CommandName = "Khulnasoft.RefactorSelectionCodeBlock"
        };
        ...
        private static readonly CodeLensDetailEntryCommand explainCommand = new CodeLensDetailEntryCommand
        {
            CommandSet = PackageGuids.KhulnasoftVS,
            CommandId = 0x0111,
            CommandName = "Khulnasoft.ExplainSelectionCodeBlock"
        };
        private static readonly CodeLensDetailEntryCommand goDocCommand = new CodeLensDetailEntryCommand
        {
            CommandSet = PackageGuids.KhulnasoftVS,
            CommandId = 0x0112,
            CommandName = "Khulnasoft.GenerateSelectionFunctionDocstring"
        };
        ...
        private readonly KhulnasoftCompletionHandler khulnasoftCompletionHandler;
        ...
        public KhulnasoftDataPoint(ICodeLensCallbackService callbackService, CodeLensDescriptor descriptor)
        {
            ...
            CancellationToken token)
        {
            try
            {
                ...
                {
                    Description = "Invoke Khulnasoft",
                    TooltipText = "Khulnasoft",
