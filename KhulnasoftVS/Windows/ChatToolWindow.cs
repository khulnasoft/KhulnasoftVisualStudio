...
{
    private KhulnasoftVSPackage package;
    ...
    private async Task InitializeWebViewAsync()
    {
        ...
        package = KhulnasoftVSPackage.Instance;
        ...
        catch (Exception ex)
        {
            ...
            await VS.MessageBox.ShowErrorAsync(
                "Khulnasoft: Failed to initialize webview core enviroment",
        ...
        var model = new InfoBarModel(
            new[] {
                new InfoBarTextSpan(
                    "It looks like Khulnasoft Chat is taking too long to load, do you want to reload? "),
    ...
    public async Task ReloadAsync()
    {
        ...
        catch (Exception ex)
        {
            ...
            await VS.MessageBox.ShowErrorAsync(
                "Khulnasoft: Failed to open the chat page",
    ...
    private string GetSetThemeScript()
    {
        ...
        return $@"
            ...
            body {{
                /* window background */
	            --khulnasoft-editor-background:               #{GetColor(CommonControlsColors.ComboBoxBackgroundBrushKey):x8};
	            --khulnasoft-editor-color:                    #{textColor:x8};
	            --khulnasoft-chat-background:                 #{GetColor(EnvironmentColors.ToolWindowBackgroundBrushKey):x8};
	            --khulnasoft-text-color:                      #{textColor:x8};

                 /* user message block */
                --khulnasoft-message-block-user-background:   #{GetColor(EnvironmentColors.VizSurfaceSteelBlueMediumBrushKey):x8};
                --khulnasoft-message-block-user-color:        #{textColor:x8};

                 /* bot message block */
	            --khulnasoft-message-block-bot-background:    #{GetColor(CommonControlsColors.ComboBoxBackgroundDisabledBrushKey):x8};
                --khulnasoft-message-block-bot-color:         #{textColor:x8};

                 /* textbox input */
	            --khulnasoft-input-background:                #{GetColor(CommonControlsColors.TextBoxBackgroundBrushKey):x8};
	            --khulnasoft-input-color:                     #{GetColor(CommonControlsColors.TextBoxTextBrushKey):x8};
	            --khulnasoft-input-placeholder:               #{GetColor(CommonControlsColors.TextBoxTextDisabledBrushKey):x8};

                /* hyperlink */
	            --khulnasoft-link-color:                      #{GetColor(EnvironmentColors.DiagReportLinkTextBrushKey):x8};
	            --khulnasoft-link-hover-color:                #{GetColor(EnvironmentColors.DiagReportLinkTextHoverColorKey):x8};
