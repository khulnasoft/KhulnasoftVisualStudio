...
public partial class EnterTokenDialogWindowControl : UserControl
{
    ...
    {
        _ = KhulnasoftVSPackage.Instance.LanguageServer.SignInWithAuthTokenAsync(authTokenInput.Text);
    ...
    {
        SettingsPage settingsPage = KhulnasoftVSPackage.Instance.SettingsPage;

        string state = Guid.NewGuid().ToString();
        string portalUrl =
            settingsPage.EnterpriseMode ? settingsPage.PortalUrl : "https://www.khulnasoft.com";
