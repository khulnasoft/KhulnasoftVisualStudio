...
internal sealed class SuggestionTagger : ITagger<SuggestionTag>
{
    ...
    public bool SetSuggestion(String newSuggestion, int caretPoint)
    {
        ...
        {
            KhulnasoftVSPackage.Instance?.LogAsync("Exception: " + ex.ToString());
            return false;
        }
    }
    ...
    public SuggestionTagger(IWpfTextView view, ITextBuffer buffer)
    {
        ...
        this.view = view;
        this.adornmentLayer = view.GetAdornmentLayer("KhulnasoftAdornmentLayer");
    ...
    public bool CompleteText()
    {
        ...
        {
            KhulnasoftVSPackage.Instance?.LogAsync("Exception: " + e.ToString());
        }
